...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        Info info = new Info();
        info.setTitle("Ghumgham API");
        info.setDescription("All Api of Ghumgham Travels");
        info.setVersion("1.0.0");
        info.setTermsOfService("http://ghumgham.com");
        info.setContact(new Contact().email("lamameelan32@gmail.com").name("Milan Tamang").url("http://ghumgham.com/contact"));
        info.setLicense(new License().name("ghumgham-travel 1.0").url("http://ghumgham.com"));
